...
const Carousel = ({ slides }) => {
  ...
  return (
    <div className="overflow-hidden relative">
      ...
      <button
        className="absolute left-[40px] top-1/2 transform -translate-y-1/2 max_720:top-[30%]"
        onClick={previousSlide}
      >
        <img src={current == 0 ? OffArrow : OnArrow} className="rotate-180" />
      </button>
      <button
        className="absolute right-[40px] top-1/2 transform -translate-y-1/2 max_720:top-[30%]"
        onClick={nextSlide}
      >
